/*
 * 4.	La casa del adulto mayor tiene 37 personas registradas y requiere un reporte de los adultos
con más de 85 años. Para ello implementa un sistema en el que se capturan el nombre y la edad de 
cada persona e imprime los datos de quienes cumplen con la condición solicitada.
 */
package adultos_mayores;
     ...
     */
     public static void main(String[] args) {
       ...
       for (int c=0;c<37;c++){
           ...
           reporte [c][1] = String.valueOf(edad); //convierte el int a un string / edad lo va a convertir en letras/ string
           }
